...
public class MyDatabase {
	...
	public static List<Product> laptopList = new ArrayList<>();
	public static List<Product> watchlist = new ArrayList<>();
	...
	// SQL :  select * from Products where productName = ? and Keyword = ? and seller = ?;	
